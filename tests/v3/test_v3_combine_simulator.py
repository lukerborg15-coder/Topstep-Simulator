...
def test_combine_simulator_groups_overnight_trades_into_same_futures_session_day():
    trades = [
        _trade("2024-01-02 18:05", -600.0),
        _trade("2024-01-03 10:00", -500.0),
        _trade("2024-01-04 10:00", 200.0),
        _trade("2024-01-05 10:00", 200.0),
        _trade("2024-01-08 10:00", 200.0),
        _trade("2024-01-09 10:00", 200.0),
        _trade("2024-01-10 10:00", 200.0),
        _trade("2024-01-11 10:00", 200.0),
        _trade("2024-01-12 10:00", 200.0),
    ]

    result = run_combine_simulator(trades, n_resamples=50, seed=42)

    assert result.n_trading_days == 8
    assert result.worst_max_drawdown == pytest.approx(1100.0)
